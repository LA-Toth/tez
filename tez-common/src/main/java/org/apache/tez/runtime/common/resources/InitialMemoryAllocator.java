...
public interface InitialMemoryAllocator extends Configurable {
  ...
  /**
   * @param availableForAllocation memory available for allocation
   * @param numTotalInputs         number of inputs for the task
   * @param numTotalOutputs        number of outputs for the tasks
   * @param requests               Iterable view of requests received
