...
//      out.println("<link rel='stylesheet' type='text/css' href=' " + config.getStyleSheet() + "'/>");
      ...
      for (ConfigProperty configProperty : config.configProperties.values()) {
        ...
        out.println("<td class=\"" + (configProperty.isPrivate ? "td_private_true" : "td_private_false") + "\">" +
          configProperty.isPrivate + "</td>");
        out.println("<td class=\"" + (configProperty.isEvolving ? "td_evolve_true" : "td_evolve_false") + "\">" +
          configProperty.isEvolving + "</td>");
        out.println("<td class=\"" + (configProperty.isUnstable ? "td_unstable_true" : "td_unstable_false") + "\">" +
