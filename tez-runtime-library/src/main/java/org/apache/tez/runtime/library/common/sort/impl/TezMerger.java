...
public class TezMerger {
  ...
  public static class DiskSegment extends Segment {
    ...
    FileSystem fs = null;
    Path file = null;
    boolean preserve = false; // Signifies whether the segment should be kept after a merge is complete. Checked in
    // the close method.
  ...
  static class MergeQueue<K extends Object, V extends Object>
     ...
     */
    static long computeBytesInMerges(List<Segment> segments, int factor, int inMem,
                                     boolean considerFinalMergeForProgress) {
