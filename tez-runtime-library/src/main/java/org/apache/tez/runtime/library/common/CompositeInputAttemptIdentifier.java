...
public class CompositeInputAttemptIdentifier extends InputAttemptIdentifier {
  ...
  public CompositeInputAttemptIdentifier(int inputIdentifier, int attemptNumber, String pathComponent,
    ...
    this(inputIdentifier, attemptNumber, pathComponent, false, SPILL_INFO.FINAL_MERGE_ENABLED, -1,
      inputIdentifierCount);
  }

  public CompositeInputAttemptIdentifier(int inputIdentifier, int attemptNumber, String pathComponent,
                                         boolean isShared, int inputIdentifierCount) {
    this(inputIdentifier, attemptNumber, pathComponent, isShared, SPILL_INFO.FINAL_MERGE_ENABLED, -1,
      inputIdentifierCount);
  }
