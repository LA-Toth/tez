...
public class TestCartesianProductVertexManagerPartitioned {
  ...
  public void testScheduling() throws Exception {
    ...
    verify(context, never()).scheduleTasks(ArgumentMatchers.<List<ScheduleTaskRequest>>any());
    ...
    for (int i = 6; i < 8; i++) {
      vertexManager.onSourceTaskCompleted(allCompletions.get(i));
      verify(context, times(4)).scheduleTasks(ArgumentMatchers.<List<ScheduleTaskRequest>>any());
    }
  }
