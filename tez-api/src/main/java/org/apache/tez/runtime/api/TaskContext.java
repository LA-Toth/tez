...
public interface TaskContext {
   ...
   * @deprecated Replaced by {@link #reportFailure(TaskFailureType, Throwable, String)} (FailureType, Throwable,
   * String)}
   * <p>
   ...
   *
   * @param serviceName the name of the service for which meta-data is required
   ...
   * as bytes
   *
   * @param serviceName the name of the service for which provider meta-data is required
   * @return a ByteBuffer representing the meta-data
   */
  @Nullable
   ...
   * @param callbackHandler the callback handler to be invoked once memory is assigned
   */
