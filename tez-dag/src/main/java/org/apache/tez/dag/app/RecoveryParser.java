      ...
      while (true) {
        ...
        switch (eventType) {
          ...
          case VERTEX_INITIALIZED: {
            ...
            VertexRecoveryData vertexRecoveryData = recoveredDAGData.maybeCreateVertexRecoveryData(
              vertexInitEvent.getVertexID());
          ...
          case VERTEX_CONFIGURE_DONE: {
            ...
            VertexRecoveryData vertexRecoveryData = recoveredDAGData.maybeCreateVertexRecoveryData(
              reconfigureDoneEvent.getVertexID());
          ...
          case VERTEX_STARTED: {
            ...
            VertexRecoveryData vertexRecoveryData = recoveredDAGData.vertexRecoveryDataMap.get(
              vertexStartedEvent.getVertexID());
            Preconditions.checkArgument(vertexRecoveryData != null,
              "No VertexInitializedEvent before VertexStartedEvent");
          ...
          case TASK_ATTEMPT_STARTED: {
            ...
            Preconditions.checkArgument(vertexRecoveryData != null,
              "Invalid TaskAttemptStartedEvent, its vertexId does not exist, taId=" +
                taStartedEvent.getTaskAttemptID());
            ...
            TaskAttemptRecoveryData taRecoveryData = taskRecoveryData.maybeCreateTaskAttemptRecoveryData(
              taStartedEvent.getTaskAttemptID());
          ...
          case TASK_ATTEMPT_FINISHED: {
            ...
            Preconditions.checkArgument(vertexRecoveryData != null,
              "Invalid TaskAttemtFinishedEvent, its vertexId does not exist, taId=" +
                taFinishedEvent.getTaskAttemptID());
            TaskRecoveryData taskRecoveryData = vertexRecoveryData.taskRecoveryDataMap
              .get(taFinishedEvent.getTaskAttemptID().getTaskID());
            Preconditions.checkArgument(taskRecoveryData != null,
              "Invalid TaskAttemptFinishedEvent, its taskId does not exist, taId=" +
                taFinishedEvent.getTaskAttemptID());
            TaskAttemptRecoveryData taRecoveryData = taskRecoveryData.maybeCreateTaskAttemptRecoveryData(
              taFinishedEvent.getTaskAttemptID());
