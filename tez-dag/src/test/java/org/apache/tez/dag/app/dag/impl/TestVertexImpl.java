...
public class TestVertexImpl {
  ...
  public void testVertexReconfigurePlannedAfterInit() throws Exception {
    ...
    try {
      ...
      Assert.assertTrue(
        e.getMessage().contains("context.vertexReconfigurationPlanned() cannot be called after initialize()"));
    }
  }
  ...
  public void testVertexWithInitializerFailure() throws Exception {
    ...
    VertexImplWithControlledInitializerManager v2 = (VertexImplWithControlledInitializerManager) vertices.get(
      "vertex2");
    Assert.assertEquals(VertexState.INITIALIZING, v2.getState());
  ...
  public void testRouteEvent_RecoveredEvent() throws IOException {
    ...
    TezEvent tezEvent1 = new TezEvent(dmEvent,
      new EventMetaData(EventProducerConsumerType.OUTPUT, "vertex1", "vertex3", taId));
