...
public class MRCombiner implements Combiner {
  ...
  public MRCombiner(TaskContext taskContext) throws IOException {
    ...
    LOG.info(
      "Using combineKeyClass: " + keyClass + ", combineValueClass: " + valClass + ", combineComparator: " + comparator +
        ", useNewApi: " + useNewApi);
  }

  private static <KEYIN, VALUEIN, KEYOUT, VALUEOUT> org.apache.hadoop.mapreduce.Reducer<KEYIN, VALUEIN, KEYOUT,
    VALUEOUT>.Context createReduceContext(
    Configuration conf,
  ...
  private void runOldCombiner(final TezRawKeyValueIterator rawIter, final Writer writer) throws IOException {
    Class<? extends Reducer> reducerClazz = (Class<? extends Reducer>) conf.getClass("mapred.combiner.class", null,
      Reducer.class);
  ...
  private void runNewCombiner(final TezRawKeyValueIterator rawIter, final Writer writer) throws InterruptedException,
    IOException {
    ...
    Class<? extends org.apache.hadoop.mapreduce.Reducer> reducerClazz = (Class<?
      extends org.apache.hadoop.mapreduce.Reducer>) conf
